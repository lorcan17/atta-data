...
-- INNER JOIN air-quality-379023.atta.priority_cities AS priority_cities ON city_dim.city = priority_cities.city AND city_dim.country = priority_cities.country
